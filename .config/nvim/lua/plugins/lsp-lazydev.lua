		...
		config = function()
			...
			local servers = {
				...
				intelephense = {
					...
					settings = {
						intelephense = {
							-- Better file associations for Laravel
							files = {
								associations = { '*.php', '*.phtml' },
								maxSize = 5000000, -- 5MB, useful for large vendor files
							},
							-- Environment settings
							environment = {
								includePaths = {}, -- Add custom paths if needed
								phpVersion = '8.3',
							},
							-- Stubs for better framework support
							stubs = {
								'apache',
								'bcmath',
								'bz2',
